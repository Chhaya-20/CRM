...
//   background: "url('https://colorlib.com/etc/lf/Login_v15/images/bg-01.jpg')",
//   backgroundPosition: "center",
//   filter: "blur(0.8px)" // Adjust the blur radius as needed
// }}>
...
// <span class="focus-input100"></span>
// </div>
// <div class="flex-sb-m w-full p-b-30" style={{
//   "display": "flex",
//       "justify-content": "end",
...
// import "../styles/Login.css";
// import img1 from "../assets/CRM_Importance.png";
// import img2 from "../assets/CRM-1-scaled.webp";
// import img3 from "../assets/crm-strategy.webp";
...
//               <span className="login100-form-title poppins-bold">Member Login</span>
//               <div
...
function Login1() {
  ...
  return (
    ...
    //           <h3 className="mb-4">
    //              <strong>Login To AVI CRM</strong>
    //           </h3>
    ...
    // </div>
    <>
    <div class="d-lg-flex half" style={{"background":"white"}}>
    <div
  className="bg order-1 order-md-2"
  style={{
    backgroundImage: `url(${currentImage})`, // Sets the background image dynamically based on the value of 'currentImage'
    backgroundSize: "contain", // Sets the size of the background image to fit within the element
    backgroundPosition: "center", // Centers the background image horizontally and vertically
    aspectRatio: "1", // Sets the aspect ratio of the div
    transition: "opacity 0.5s ease", // Adds a transition effect for opacity changes
    opacity: isFadingOut ? 0 : 1, // Sets the opacity based on the value of 'isFadingOut'
...
<div class="container">
<div class="row align-items-center justify-content-center">
<div class="col-md-7" style={{"box-shadow": "#00000036 5px 5px 5px 5px"}}>
<h3 className="mt-4"> <strong>Login to AVI CRM</strong></h3>
...
<input type="submit" value="Log In" class="btn btn-block btn-primary mb-4"/>
</form>
</div>
</div>
</div>
